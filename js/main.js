...
function checkCurrentUserAndRedirect() {
	...
	if (!user) {
	  ...
	  // You can optionally do something else for a logged-in user here
	}
  }
  ...
  document.addEventListener('click', function(event) {
	...
	if (!profileBtn.contains(event.target)) {
	  ...
	  document.getElementById('arrowhide').style.display = 'block';
	}
  });
